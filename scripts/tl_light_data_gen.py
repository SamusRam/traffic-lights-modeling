...
dm = LocalDataManager()
if input_name != 'test':
    dataset_path = dm.require(f'scenes/{input_name}_filtered_min_frame_history_4_min_frame_future_1_with_mask_idx.zarr')
else:
    dataset_path = dm.require(f'scenes/test.zarr')
...
tl_events_df[['scene_idx', 'frame_idx', 'master_intersection_idx', 'timestamp', 'rnn_inputs_raw', 'tl_signal_classes', 'time_to_tl_change']].to_hdf(f'../input/tl_events_df_{input_name}_{fold_i}.hdf5', key='data')
